...
public class NetworkStateChecker extends BroadcastReceiver {
    ...
    * */
    private void saveName(final int id, final String mssv,final String idSuKien) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DanhsachsinhvienActivity.URL_SAVE_NAME,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                db.updateNameStatus(id, DanhsachsinhvienActivity.NAME_SYNCED_WITH_SERVER);

                                //sending the broadcast to refresh the list
                                context.sendBroadcast(new Intent(DanhsachsinhvienActivity.DATA_SAVED_BROADCAST));
                            }
